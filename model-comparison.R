...
# read stan model
stan_model_pl <- stan_model("powerlaw.stan", model_name = "powerlaw")
stan_model_hierarchical_pl <- stan_model("hierarchical-powerlaw.stan", model_name = "hierarchical-powerlaw")
stan_model_hierarchical_pl_groupwise <- stan_model("hierarchical-powerlaw-groupwise.stan", model_name = "hierarchical-powerlaw-groupwise")
